			...
			<div class="login-right">
				...
				<form action="login.do" method="post">
					<div class="login-user">
						<i class="iconfont icon-zhanghao"></i><input type="text" name="userName" value="" placeholder="账号" class="" />
					</div>
					<div class="login-pwd">
						<i class="iconfont icon-password"></i><input type="password" name="pwd" value="" placeholder="密码" />
					</div>
					...
					<div class="shop-topper-box">
						...
						<div class="shop-login-div">
							...
							<c:if test="${not empty u">
								<a class="shop-login-name" href="javascript:void(0);"><c:out value="${u.userName }"/>,</a>
				...
				<div class="shop-nav">
					<div class="shop-nav-box">
						<div class="shop-nav-div">
							...
							<a class="game shop_nav_a" href="javascript:void(0)">游戏手办</a>
							<a class="subject shop_nav_a" href="javascript:void(0)">主题服饰</a>
							<a class="T_shit shop_nav_a" href="javascript:void(0)">创意T恤</a>
							<a class="toy shop_nav_a" href="javascript:void(0)">毛绒玩具</a>
							<a class="live shop_nav_a" href="javascript:void(0)">生活用品</a>
							<a class="limit shop_nav_a" href="javascript:void(0)">特别限量</a>
						</div>	
